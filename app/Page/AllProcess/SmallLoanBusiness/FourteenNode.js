...
export default class FourteenNode extends Component {
        ...
        return (
            <View style={styles.container}>
                ...
                {this.state.oppositeType == 'company_customer' ?
                    <Menu name={'企业基本信息'} pageName={'EnterpriseCusBasicInfo'} data={this.state} selectDisabled={true} inputDisabled={true} chooseDisabled={false}/> : null}
                {this.state.oppositeType == 'company_customer' ?
                    <Menu name={'法人代表信息'} pageName={'LegalPersonRepresentInfo'} data={this.state} selectDisabled={true} inputDisabled={true} chooseDisabled={false}/> : null}
                {this.state.oppositeType == 'person_customer' ?
                    <Menu name={'客户基本信息'} pageName={'PersonDetail'} data={this.state} selectDisabled={true} inputDisabled={true}/> : null}
                ...
                <Menu name={'付款申请'} pageName={'PaymentRequest'} data={this.state} inputDisabled={true} selectDisabled={false} chooseDisabled={false} datePickerDisabled={false}/>
