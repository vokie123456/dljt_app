...
export default class EleventhNode extends Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                {/*<View style={{borderBottomWidth: StyleSheet.hairlineWidth,borderBottomColor: '#EEEEEE',paddingLeft: px2dp(35), paddingTop: px2dp(15)}}>*/}
                    {/*<Text style={{fontSize: px2dp(27), color: '#ff514c'}}>尽职调查报告</Text>*/}
                    {/*<Icon name={"ios-add-circle-outline"} color={"#a1a1a1"} size={45} />*/}
                {/*</View>*/}
                <Menu name={'集团内关联业务'} pageName={'ReviewTheContent'} data={this.state} inputDisabled={true}/>
                <Menu name={'评审会意见'} pageName={'JudgesAdvices'} data={this.state} inputDisabled={true}/>
                <Menu name={'尽职调查报告'} pageName={'SurveyReportFile'} data={this.state} inputDisabled={true}/>
                <View style={{marginBottom: px2dp(120),borderBottomWidth: hair,borderBottomColor: '#EEEEEE',}}></View>
