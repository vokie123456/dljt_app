...
export default class SeventeenthNode1 extends Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                {/*<Menu name={'借款合同'} pageName={'ReviewTheContent'} data={this.state} inputDisabled={false}/>*/}
