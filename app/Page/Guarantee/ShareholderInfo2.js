    ...
    return (
        <View style={{
            ...
            <Input
                ...
                editable={!inputDisabled?props.disabled?false:true:true}
                value={props.valOne}
            ...
            <KeyboardAwareScrollView>
                <View style={{paddingLeft: px2dp(36), backgroundColor: '#fff', marginTop: px2dp(20)}}>
                    ...
                    <DefaultInput placeholder={'请输入'} name={'抵押价值（元）: '}
                                  ...
                                  props={props}/>
                    <DefaultInput  disabled  placeholder={'请输入'} name={'抵质押率（%）: '}
...
export default class CollateralGuarantee2 extends Component {
    ...
    //查看信息
    _seeInfo() {
        let url = Config.baseApi + Config.twoApi.seeVehicle + this.state.id;//个人客户信息
