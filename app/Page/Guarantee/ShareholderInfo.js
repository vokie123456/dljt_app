...
export default class ShareholderInfo extends Component {
    ...
    _seeInfo() {
        let url = Config.baseApi + Config.twoApi.findDYList  + this.props.data.data.vars[0].projectId;
                ...
                >
                    <View style={styles.contacts}>
                        <TouchableOpacity
                            ...
                            activeOpacity={.8}
                            onPress={()=>Actions.ShareholderInfo2({data:rowData.item.value,type1: "see",data1:rowData.item.value})}
                        >
                            <View
    ...
    render() {
        return (
            <View style={styles.container}>
                <Title name={this.props.title} rightText={this.props.inputDisabled?"":"md-add"}  back onPress="ShareholderInfo2" type="add" {...this.props.data}/>
                <ImageBackground
                    resizeMode={"stretch"}
