            ...
            <KeyboardAwareScrollView>
                <View style={{paddingLeft: px2dp(15), backgroundColor: '#fff'}}>
                    ...
                    <DefaultInput border placeholder={'请输入'} valOne={props.netassets} name={'资产价值：万元'}
                                  onChangeText={props.onChangeNetassets}/>
...
export default class CustomerMortgageDetail extends Component {

    // 构造
    constructor(props) {
        super(props);
        // 初始状态
        console.log("NEXTPROPS", props.personstype.assureofname);
        this.state = {
            id: props.personstype.id,
            projid: props.personstype.projid,//项目id
            assureofname: props.personstype.assureofname,//项目id
            businessType: props.personstype.businessType,//项目id
            mortgagename: props.personstype.mortgagename,//保证人公司
    ...
    _addCustomer() {
        const {assureofname,projid,mortgagename,businessType,assuremodeid,id,monthlyIncome,netassets,legalperson_en,legalpersonid,assets,relation,mortgageRemarks,cciaa,telephone,cellphone,area,business}=this.state
