...
export default class LoanContractFileLImageList extends Component {
    ...
    _seeInfo() {
        let url = Config.baseApi + "/api/getUploadedListFile.do?mark=cs_procredit_contract." +  this.props.projectId;
        RTRequest.fetch1(url).then((responseText) => {
            if (responseText) {
                console.log('合同附件查看', responseText);
