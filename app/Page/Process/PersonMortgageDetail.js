        ...
        <ScrollView>
            <KeyboardAwareScrollView>
                <View style={{paddingLeft: px2dp(15), backgroundColor: '#fff'}}>
                    ...
                    <DefaultChoice require name={'保证人'} valOne={props.mortgagename} action="personCustomers"/>
                    <DefaultInput  placeholder={'请输入'} valOne={props.relation} name={'与债务人关系'} onChangeText={props.onChangeRelation}/>
                    <DefaultInput  placeholder={'请输入'} valOne={props.mortgageRemarks} name={'备注'} onChangeText={props.onChangeMortgageRemarks}/>
                    ...
                    <DefaultInput  border placeholder={'请输入'} valOne={props.business} name={'主营业务或职务'} onChangeText={props.onChangeBusiness}/>
                    <DefaultInput  border placeholder={'请输入'} valOne={props.assets} name={'主要资产'} onChangeText={props.onChangeAssets}/>
                    <DefaultInput border placeholder={'请输入'} valOne={props.assetvalue} name={'资产价值：万元'} onChangeText={props.onChangeAssetvalue}/>
                    <DefaultInput  border placeholder={'请输入'} valOne={props.monthlyIncome} name={'月营业额'} onChangeText={props.onChangeMonthlyIncome}/>
                </View>
            </KeyboardAwareScrollView>
        </ScrollView>
    )
}
export default class PersonMortgageDetail extends Component {
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
        console.log("NEXTPROPS",props.personstype);
        this.state = {
            id:props.personstype.id,
            projid:props.personstype.projid,//项目id
            businessType:props.personstype.businessType,//项目id
            mortgagename:props.personstype.mortgagename,//保证人个人
            assureofname:props.personstype.assureofname,
            assuremodeidValue: props.personstype.assuremodeidValue,//保证方式
            assuremodeid: props.personstype.assuremodeid,
            assuremodeidArray: [
                {text: "一般责任", value: "607"},
                {text: "连带责任", value: "608"}
            ],
            relation:props.personstype.relation,//债务人关系
            mortgageRemarks:props.personstype.mortgageRemarks,//备注
            cardnumber:props.data.allData.person.cardnumber,//营业执照
            cellphone:props.data.allData.person.cellphone,//法人电话
            familyaddress:props.data.allData.person.familyaddress,//家庭地址
            business:'',//主营业务
            assets:'',//主要资产
            assetvalue:'',//资产价值
            monthlyIncome:'',//月营业额
    ...
    _addPerson() {
        const {id,projid,assureofname,businessType,mortgagename,assuremodeid,monthlyIncome,assetvalue,assets,relation,mortgageRemarks,cardnumber,cellphone,familyaddress,business}=this.state
