...
export default class DZYMortgageViewList extends Component {
    ...
    _seeInfo() {
        let url = Config.baseApi + Config.processApi.findDYList  + this.props.data.data.vars[0].projectId;
                ...
                >
                    <View style={styles.contacts}>
                        <TouchableOpacity
                            ...
                            activeOpacity={.8}
                            onPress={()=>Actions.DZYMortgageViewDetail2({data:rowData.item.value,type1: "see",data1:this1.props})}
                        >
                            <View
    ...
    render() {
        return (
            <View style={styles.container}>
                <Title name={this.props.title} rightText={this.props.inputDisabled?"":"md-add"}  back onPress="DZYMortgageViewDetail2" type="add" {...this.props.data}/>
                <ImageBackground
                    resizeMode={"stretch"}
